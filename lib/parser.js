...
function Lexer() {
  ...
  function _normalLex() {
    ...
    switch (c) {
      ...
      case '\\':
        // check for backreferences. multiple digits are allowed
        if (isNum(text[pos]) && text[pos] !== '0') {
          var num = lexInt();
          this.yytext = '\\' + num;
          return 'tBACKREF';
        }
        c = this.yytext = text[pos++];
        // fallthrough to default

        // TODO: normal escapes, shorthand character classes, anchors
